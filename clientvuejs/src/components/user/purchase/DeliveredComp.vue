...
export default {
    ...
    mounted(){
        ...
        BaseRequest.get('api/customer-order/delivered?id='+this.user.id)
        .then( (data) =>{
    ...
    methods:{
        ...
        fsortlatest:function(){
            ...
            const { emitEvent } = useEventBus();
            BaseRequest.get('api/customer-order/delivered?id='+this.user.id+'&page='+this.pageN+'&search='+this.searchad+'&sort='+this.sortlatest)
            .then( (data) =>{
                this.customer_orders = data.customer_order.data;
                this.quantity = data.customer_order.total;
                emitEvent('eventUserSuccess','Show Orders Success !');
        ...
        clickCallback:function(pageNum){
            this.pageN = pageNum;
            const { emitEvent } = useEventBus();
            BaseRequest.get('api/customer-order/delivered?id='+this.user.id+'&page='+pageNum+'&search='+this.searchad+'&sort='+this.sortlatest)
            .then( (data) =>{
                this.customer_orders = data.customer_order.data;
                this.quantity = data.customer_order.total;
                emitEvent('eventUserSuccess','Show Orders Success !');
