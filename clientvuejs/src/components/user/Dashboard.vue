        ...
        <div id="main">
            <div id="left">
                <div id="category_sidebar" v-if="!status_show">
                    ...
                    <div id="list_category">
                        <li v-for="(category, index) in categorys" :key="index" @click="categoryClick(category.name)"><i
                                class="fa-solid fa-angles-right"></i> {{ category.name }}</li>
                    </div>
                </div>
                <div id="fill_sidebar" v-if="status_show">
                    ...
                    <div id="from_to">
                        <div class="row">
                            <span>$ From</span>
                            <div class="col-8">
                                <input type="number" min="0" v-model="price_from" class="form-control col-12"
                                    placeholder="$ From">
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-8" style="display:flex;align-item:center">
                                <input type="number" v-model="price_to" min="0" class="form-control col-12"
                                    placeholder="$ To">
                            </div>
                        </div>
                    </div>
            ...
            <div id="right_bar">
                <div id="search" class="row">
                    ...
                    <div class="col-1.5">
                        <button
                            :class="{ btn: true, 'btn-outline-primary': sortlatest == false, 'btn-primary': sortlatest == true }"
                            @click="clickLatest"><i class="fa-solid fa-star"></i> Latest</button>
                    </div>
                    <div class="col-3">
                    ...
                    <div class="col-1.5">
                        <button
                            :class="{ btn: true, 'btn-outline-primary': status_show == false, 'btn-primary': status_show == true }"
                            @click="status_show = !status_show"><i class="fa-solid fa-filter-circle-dollar"></i> Filter
                            Price</button>
                    </div>
                </div>
                ...
                <div id="product">
                    <li v-for="(pr, index) in products" :key="index" class="li_product">
                        <div class="top">
                            <div :id="'carouselExampleControls' + index" class="carousel slide" data-ride="carousel"
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <div class="carousel-item imgproduct" v-for="(img, index2) in images[index]"
                                        :key="index2">
                                        <img class="d-block w-100" :src="domain + '/' + img.image_path">
                                    </div>
                                </div>
                                <a class="carousel-control-prev" :href="'#carouselExampleControls' + index" role="button"
                                    data-slide="prev">
                                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                    <span class="sr-only">Previous</span>
                                </a>
                                <a class="carousel-control-next" :href="'#carouselExampleControls' + index" role="button"
                                    data-slide="next">
                        ...
                        <div>
                            <p class="product_name" @click="viewDetail(pr.uri, pr.product_id)"><i
                                    class="fa-brands fa-dropbox" style="margin-top:4px;margin-right:2px"></i>
                                {{ pr.product_name }}</p>
                ...
                <div id="divpaginate">
                    <paginate class="pag" id="nvm" :page-count="Math.ceil(this.quantity / 20)" :page-range="3"
                        :margin-pages="2" :click-handler="clickCallback" :initial-page="this.pageN" :prev-text="'Prev'"
