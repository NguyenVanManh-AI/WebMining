...
INSERT INTO `customer_orders` (`id`, `customer_id`, `hex_id`, `customer_name`, `recipient_name`, `phone_number`, `address`, `order_status`, `order_time`, `confirm_time`, `ship_time`, `completed_time`, `shipping_fee`, `created_at`, `updated_at`) VALUES
	...
	(22, 10, '220b57963a36013a7537', 'Nguyen Van Hoang Phuc', 'Nguyễn Văn Hoàng Phúc', '0123456999', 'Hội An - Việt Nam', 1, '2024-04-29 11:20:40', NULL, NULL, NULL, 219000, '2024-04-28 21:20:40', '2024-04-28 21:20:40'),
...
-- Dumping data for table pbl4.imports: ~0 rows (approximately)
...
-- Dumping data for table pbl4.import_details: ~0 rows (approximately)
...
-- Dumping data for table pbl4.order_details: ~81 rows (approximately)
...
INSERT INTO `products` (`id`, `name`, `quantity`, `warranty_period`, `description`, `category_id`, `price`, `material`, `dimension`, `uri`, `created_at`, `updated_at`) VALUES
	...
	(57, 'Loa JPL', 75, '2022-10-20', 'JBL charge 3 là một sản phẩm độc quyền của thương hiệu JBL, có xuất xứ từ Mỹ. Đây là một thiết bị loa bluetooth từ khi ra mắt đã được rất nhiều người săn đón. Bởi lẽ, người ta yêu thích và lựa chọn dòng loa này là do sự dung hòa tuyệt đỉnh giữa chất lượng âm thanh, pin trâu và khả năng chống nước bền bỉ.', 46, 300000.00, 'Thép', '213 x 87 x 88,5 mm', '8406e6175cd5d31d8c49', '2022-10-24 22:40:16', '2024-04-28 21:25:29'),
	...
	(59, 'Bàn phím cơ', 71, '2022-12-09', 'Bàn phím cơ giá tốt', 48, 450000.00, 'Nhựa', '20cmx10cm', 'c80aa2615376a523f289', '2022-10-25 00:21:59', '2024-04-28 21:32:08'),
	...
	(62, 'Đắc Nhân Tâm', 991, '2023-02-10', 'Sách hay - Đắc nhân tâm', 13, 345000.00, 'Bìa cứng', '20cm - 6cm', 'a6167fbae577e26eeb60', '2022-10-25 00:51:43', '2024-04-28 21:22:45'),
...
INSERT INTO `user_datas` (`id`, `id_user`, `recent_care`, `recent_add`, `recent_buy`, `created_at`, `updated_at`) VALUES
	(9, 25, '[63, 67, 68]', '[]', '[1, 2]', '2024-04-28 21:32:43', '2024-04-28 21:32:43'),
	(10, 31, '[2, 55, 57, 58, 64]', '[]', '[14]', '2024-04-28 21:32:43', '2024-04-28 21:32:43'),
	(11, 10, '[13, 56, 60, 66, 67]', '[]', '[57, 59, 62]', '2024-04-28 21:32:43', '2024-04-28 21:32:43'),
	(12, 1, '[1, 57, 61, 64, 70]', '[]', '[54, 59, 62, 67, 68]', '2024-04-28 21:32:43', '2024-04-28 21:32:43'),
	(13, 2, '[13, 58, 62, 66, 72]', '[]', '[57, 68, 69]', '2024-04-28 21:32:43', '2024-04-28 21:32:43'),
	(14, 14, '[2, 61, 68, 69, 72]', '[]', '[1, 56, 70, 71]', '2024-04-28 21:32:43', '2024-04-28 21:32:43'),
	(15, 11, '[14, 54, 55, 63, 68]', '[]', '[2, 56, 58, 64]', '2024-04-28 21:32:43', '2024-04-28 21:32:43'),
	(16, 9, '[56, 57, 61, 64, 72]', '[]', '[54, 58]', '2024-04-28 21:32:43', '2024-04-28 21:32:43');
